...
class SubMenu extends Component{
  ...
  constructor(props) {
    ...
    this.getOpenClassName = this.getOpenClassName.bind(this);
    this.saveMenuInstance = this.saveMenuInstance.bind(this);
    this.addKeyPath = this.addKeyPath.bind(this);
    this.triggerOpenChange = this.triggerOpenChange.bind(this);
    this.clearSubMenuTimers = this.clearSubMenuTimers.bind(this);

        


    this.clearSubMenuLeaveTimer = this.clearSubMenuLeaveTimer.bind(this);
    this.clearSubMenuTitleLeaveTimer = this.clearSubMenuTitleLeaveTimer.bind(this);
    this.isChildrenSelected = this.isChildrenSelected.bind(this);
